...
const apikey='f56cca4dbcc166f2f6fca2e5b294c01d';
...
document.getElementById('search').adddEventListener('click',()=>{
...
function dayForecast(forecast){
    ...
    for(let i=0;i<forecast.list.length;i+=8){
        ...
        day.innerText=new Date(forecast.list[i].dt*1000).toDateString(undefine,'Asia/kolkata');
        div.appendChild(day);
